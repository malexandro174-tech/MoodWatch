...
def build_ai_insight_prompt(
    ...
    return (
        ...
        "Describe the dominant communication style of the analysed discussion.\n\n"
        "# Rationality Index\n\n"
        "Return a score from 0 to 100 and an explanation based on argument "
        "quality, evidence, logic, and emotionality.\n\n"
        "# Emotional Reactivity\n\n"
        "Return low, medium, or high, with an explanation.\n\n"
        "# Manipulation Susceptibility Estimate\n\n"
        "Return low, medium, or high. Explain carefully that this is an "
        "estimate based only on observed discussion patterns.\n\n"
        "# Audience Archetype\n\n"
        "Give 1-3 likely audience archetypes, for example: anxious observers, "
        "ideological fighters, pragmatic analysts, emotional reactors, "
        "skeptical investigators.\n\n"
        "# Bot / Organic Activity Estimate\n\n"
        "Return Organic audience likelihood from 0 to 100 and Bot-like / "
        "coordinated activity likelihood from 0 to 100. Explain using only "
        "text-level signals: repeated phrases, template-like comments, "
        "narrative uniformity, low semantic diversity, unnatural repetition, "
        "or weak relation to the post.\n\n"
        "Research context:\n"
        ...
        "messages": [
            {
                ...
                "content": (
                    ...
                    "Do not claim that specific users are bots. Do not identify "
                    "individuals. Do not make definitive claims about real "
                    "psychological traits. Use cautious wording such as 'may "
                    "indicate', 'suggests', 'in this sample', and 'based on text "
                    "patterns'. Do not infer protected attributes or social "
                    "class. Do not use insulting labels. Analyse only the "
                    "discussion, not individual people."
                ),
            },
            {
                "role": "user",
